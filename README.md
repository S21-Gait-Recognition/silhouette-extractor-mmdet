# Human Silhouette Extractor Using MMDetection Instance Segmentation Models [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
